...
BOOL GhciSendCommandSynch(int id, const char* cmd, const char* eod, DWORD timeout, const char** output)
{
	return (BOOL)CGhciManager::Instance().SendCommandSynch(id, cmd, eod, timeout, output);
}
